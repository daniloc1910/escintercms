  ...
  <div class="category-item grid3">
    ...
    <div class="titlebutton">
      ...
      <n-link class="product-item-1" :to="'/' + linkproduct1">
        ...
        <li><img :src="require('~/assets/images/nuxt.jpg').placeholder" :data-srcset="require('~/assets/images/' + imgproduct1).srcSet" class="lazyload" /></li>
      ...
      <n-link class="product-item-1" :to="'/' + linkproduct2">
        <ul class="product-item-container">
        <li><img :src="require('~/assets/images/nuxt.jpg').placeholder" :data-srcset="require('~/assets/images/' + imgproduct2).srcSet" class="lazyload" /></li>
