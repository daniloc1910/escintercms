<template>
  <div class="content">
    ...
    <div class="intro grid3">
      <h1 class="pressura60 intro-title">
        Soluções integradas para ambientes corporativos
      </h1>
        ...
        <div class="carousel-cell">
          <img
            :data-flickity-lazyload-srcset="
              require('~/assets/images/destaquehome/01.jpg').srcSet
            "
          />
        </div>
        <div class="carousel-cell">
          <img
            :data-flickity-lazyload-srcset="
              require('~/assets/images/destaquehome/02.jpg').srcSet
            "
          />
        </div>
        <div class="carousel-cell">
          <img
            :data-flickity-lazyload-srcset="
              require('~/assets/images/destaquehome/03.jpg').srcSet
            "
          />
        </div>
        <div class="carousel-cell">
          <img
            :data-flickity-lazyload-srcset="
              require('~/assets/images/destaquehome/04.jpg').srcSet
            "
          />
        </div>
        <div class="carousel-cell">
          <img
            :data-flickity-lazyload-srcset="
              require('~/assets/images/destaquehome/05.jpg').srcSet
            "
          />
        </div>
        <div class="carousel-cell">
          <img
            :data-flickity-lazyload-srcset="
              require('~/assets/images/destaquehome/06.jpg').srcSet
            "
          />
        </div>
        <div class="carousel-cell">
    ...
    <nuxt-link
      ...
      class="workbetter-container grid3"
    >
      <div class="workbetter-block-txt">
        <h2 class="workbetter-block-txt-title pressura56">
          Linha<br />Workbetter
        </h2>
        <p class="workbetter-block-txt-description graphik18 gray">
          A linha corporativa da Escinter totalmente facbricada no Brasil, que
          vai ficar perfeita no seu escritório
        </p>
        <p class="pressura15 pink">Conhecer a linha completa</p>
      </div>

      <img
        :data-srcset="require('~/assets/workbetter-destaque.jpg').srcSet"
        class="wb-destaque lazyload"
      />
    </nuxt-link>
    ...
    <nuxt-link to="/clientes" class="cases-container grid3">
...
.block-txt-knoll-title {
  margin-bottom: 16px;
}

.block-txt-knoll-description {
  margin-bottom: 32px;
}
...
.workbetter-block-txt-title {
  margin-bottom: 16px;
  color: #222;
}

.workbetter-block-txt-description {
  margin-bottom: 32px;
}
