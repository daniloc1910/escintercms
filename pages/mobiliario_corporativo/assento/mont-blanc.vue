  ...
  <div class="content">
    ...
    <div class="product-highlight grid3">
      <div class="product-name">
        <ul class="product-info">
          ...
          <li class="pressura56 black"><h1>Mont Blanc</h1></li>
        </ul>
      </div>
      <img
        :src="require('~/assets/images/nuxt.jpg').placeholder"
        :data-srcset="
          require('~/assets/images/mobiliariocorporativo/assentos/2_21_FWay_MontBlanc/hero.jpg')
            .srcSet
        "
    ...
    <div class="galeria-imagens grid3">
      <img
        :src="require('~/assets/images/nuxt.jpg').placeholder"
        :data-srcset="
          require('~/assets/images/mobiliariocorporativo/assentos/2_21_FWay_MontBlanc/vertical.jpg')
            .srcSet
        "
        class="lazyload"
      />
      <img
        :src="require('~/assets/images/nuxt.jpg').placeholder"
        :data-srcset="
          require('~/assets/images/mobiliariocorporativo/assentos/2_21_FWay_MontBlanc/horizontal.jpg')
            .srcSet
        "
    ...
    <RelatedProduct
      ...
      nameproduct2="Nox"
      brandproduct2="F.WAY"
      linkproduct2="mobiliario_corporativo/assento/nox"
    />
  </div>
</template>
