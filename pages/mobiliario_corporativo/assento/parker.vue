  ...
  <div class="product-highlight grid3">
    <div class="product-name">
      <ul class="product-info">
        ...
        <li class="pressura56 black"><h1>Parker</h1></li>
      </ul>
    </div>
    <img :src="require('~/assets/images/nuxt.jpg').placeholder" :data-srcset="require('~/assets/images/mobiliariocorporativo/assentos/2_8_FWay_Parker/hero.jpg').srcSet" class="product-image lazyload" />
  </div>
