...
<div class="content">
  ...
  <div class="product-highlight grid3">
    ...
    <img :src="require('~/assets/images/nuxt.jpg').placeholder" :data-srcset="require('~/assets/images/mobiliariocorporativo/estacaodetrabalho/1_3_Executivo/1_3_2_Knoll_Antenna/hero.jpg').srcSet" class="product-image lazyload" />
  </div>
  ...
  <!-- PRODUTOS RELACIONADOS -->
    ...
    <RelatedProduct
      imgproduct1="mobiliariocorporativo/estacaodetrabalho/1_3_Executivo/1_3_1_Escinter_Target/hero.jpg"
      nameproduct1="Target"
      brandproduct1="Escinter"
      linkproduct1="mobiliario_corporativo/estacaodetrabalho/executivo-target"
