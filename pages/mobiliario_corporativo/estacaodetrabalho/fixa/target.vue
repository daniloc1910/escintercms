<template>
    <div class="container">
        ...
        <div class="product-highlight grid3">
            ...
            <img :src="require('~/assets/images/nuxt.jpg').placeholder" :data-srcset="require('~/assets/images/mobiliariocorporativo/estacaodetrabalho/1_1_Fixas/1_1_1_Escinter_Target/hero-carrossel/target.jpg').srcSet" class="product-image lazyload" />
