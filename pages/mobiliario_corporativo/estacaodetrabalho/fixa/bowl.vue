    ...
    <div class="container">
        ...
        <div class="product-highlight grid3">
            ...
            <ul class="product-info">
                ...
                <li class="pressura56 black"><h1>Bowl</h1></li>
            </ul>
            </div>
            <img :src="require('~/assets/images/nuxt.jpg').placeholder" :data-srcset="require('~/assets/images/mobiliariocorporativo/estacaodetrabalho/1_1_Fixas/1_1_1_Escinter_Target/hero-carrossel/bowl.jpg').srcSet" class="product-image lazyload" />
