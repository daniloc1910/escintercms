...
<div class="content">
  ...
  <div class="product-highlight grid3">
    <div class="product-name">
      <ul class="product-info">
        ...
        <li class="pressura56 black"><h1>Float</h1></li>
      </ul>
    </div>
    <img :src="require('~/assets/images/nuxt.jpg').placeholder" :data-srcset="require('~/assets/images/mobiliariocorporativo/estacaodetrabalho/1_2_Regulaveis/1_2_4_Humanscale_Float/hero.jpg').srcSet" class="product-image lazyload" />
  </div>
  ...
  <div class="informacoes-tecnicas grid3">
    ...
    <img :src="require('~/assets/images/nuxt.jpg').placeholder" :data-srcset="require('~/assets/images/mobiliariocorporativo/estacaodetrabalho/1_2_Regulaveis/1_2_4_Humanscale_Float/desenho.jpg').srcSet" class="lazyload desenho-tecnico coluna2" />
    <ul class="tabela coluna2">
      <li class="pressura15 gray">Bases disponíveis<span class="item-right black">3</span></li>
      <li class="pressura15 gray">Tampos disponíveis<span class="item-right black">5</span></li>
    </ul>

    <ul class="tabela coluna3">
      <li class="download pressura15 pink"><a href="/pdf/estacaodetrabalho/1_2_Regulaveis/1_2_4_Humanscale_Float/Float_Brochure.pdf" target="_blank">Download do catálogo<span class="item-right"><span class="arrow-btn">↓</span><span class="arrow-btn-hover">↓</span></span></a></li>
    </ul>
  </div>
