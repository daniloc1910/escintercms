...
<div class="content">
  ...
  <div class="product-highlight grid3">
    <div class="product-name">
      <ul class="product-info">
        ...
        <li class="pressura56 black"><h1>Intercomp</h1></li>
      </ul>
    </div>
    <img :src="require('~/assets/images/nuxt.jpg').placeholder" :data-srcset="require('~/assets/images/mobiliariocorporativo/workbetter/6_8_Escinter_Intercomp/hero.jpg').srcSet" class="product-image lazyload" />
  </div>
  ...
  <!-- PRODUTOS RELACIONADOS -->
    ...
    <RelatedProduct
      imgproduct1="mobiliariocorporativo/workbetter/6_6_Escinter_Dot/hero.jpg"
      nameproduct1="Dot"
