...
<div class="content">
  ...
  <div class="product-highlight grid3">
    ...
    <img :data-srcset="require('~/assets/images/mobiliariocorporativo/colaborativos/5_1_Cadeiras/5_1_7_Kusch_Arn/hero.jpg').srcSet" class="product-image lazyload" />
  </div>
  ...
  <div class="galeria-imagens grid3">
    <img :data-srcset="require('~/assets/images/mobiliariocorporativo/colaborativos/5_1_Cadeiras/5_1_7_Kusch_Arn/vertical.jpg').srcSet" class="lazyload" />
    <img :data-srcset="require('~/assets/images/mobiliariocorporativo/colaborativos/5_1_Cadeiras/5_1_7_Kusch_Arn/horizontal.jpg').srcSet" class="lazyload coluna2-3" />
  </div>
