...
<div class="content">
  ...
  <div class="product-highlight grid3">
    ...
    <img :data-srcset="require('~/assets/images/mobiliariocorporativo/colaborativos/5_7_Mesa_Cafe/5_7_2_Kusch_Plieto/hero.jpg').srcSet" class="product-image lazyload" />
  </div>
  ...
  <div class="galeria-imagens grid3">
    <img :data-srcset="require('~/assets/images/mobiliariocorporativo/colaborativos/5_7_Mesa_Cafe/5_7_2_Kusch_Plieto/vertical.jpg').srcSet" class="lazyload" />
    <img :data-srcset="require('~/assets/images/mobiliariocorporativo/colaborativos/5_7_Mesa_Cafe/5_7_2_Kusch_Plieto/horizontal.jpg').srcSet" class="lazyload coluna2-3" />
  </div>
