...
<div class="content">
  ...
  <div class="product-highlight grid3">
    ...
    <img :data-srcset="require('~/assets/images/mobiliariocorporativo/colaborativos/5_1_Cadeiras/5_1_8_Maxdesign_Max/hero.jpg').srcSet" class="product-image lazyload" />
  </div>
  ...
  <div class="galeria-imagens grid3">
    <img :data-srcset="require('~/assets/images/mobiliariocorporativo/colaborativos/5_1_Cadeiras/5_1_8_Maxdesign_Max/vertical.jpg').srcSet" class="lazyload" />
    <img :data-srcset="require('~/assets/images/mobiliariocorporativo/colaborativos/5_1_Cadeiras/5_1_8_Maxdesign_Max/horizontal.jpg').srcSet" class="lazyload coluna2-3" />
  </div>
  ...
  <div class="informacoes-tecnicas grid3">
    ...
    <img :data-srcset="require('~/assets/images/mobiliariocorporativo/colaborativos/5_1_Cadeiras/5_1_8_Maxdesign_Max/desenho.jpg').srcSet" class="lazyload desenho-tecnico coluna2" />
