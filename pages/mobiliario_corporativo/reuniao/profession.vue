  ...
  <div class="content">
    ...
    <div class="product-highlight grid3">
      ...
      <img
        ...
        :data-srcset="
          require('~/assets/images/mobiliariocorporativo/reunioes/3_4_Kush_Profesion/hero.jpg')
            .srcSet
        "
    ...
    <div class="galeria-imagens grid3">
      <img
        :src="require('~/assets/images/nuxt.jpg').placeholder"
        :data-srcset="
          require('~/assets/images/mobiliariocorporativo/reunioes/3_4_Kush_Profesion/vertical.jpg')
            .srcSet
        "
        class="lazyload"
      />
      <img
        :src="require('~/assets/images/nuxt.jpg').placeholder"
        :data-srcset="
          require('~/assets/images/mobiliariocorporativo/reunioes/3_4_Kush_Profesion/horizontal.jpg')
            .srcSet
        "
