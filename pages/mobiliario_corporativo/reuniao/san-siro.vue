  ...
  <div class="content">
    ...
    <div class="product-highlight grid3">
      ...
      <img
        ...
        :data-srcset="
          require('~/assets/images/mobiliariocorporativo/reunioes/3_5_Kush_Sansiro/hero.jpg')
            .srcSet
        "
    ...
    <div class="galeria-imagens grid3">
      <img
        :src="require('~/assets/images/nuxt.jpg').placeholder"
        :data-srcset="
          require('~/assets/images/mobiliariocorporativo/reunioes/3_5_Kush_Sansiro/vertical.jpg')
            .srcSet
        "
        class="lazyload"
      />
      <img
        :src="require('~/assets/images/nuxt.jpg').placeholder"
        :data-srcset="
          require('~/assets/images/mobiliariocorporativo/reunioes/3_5_Kush_Sansiro/horizontal.jpg')
            .srcSet
        "
